...
SELECT language FROM countrylanguage JOIN country ON countrylanguage.countrycode = country.code WHERE name = 'Holy See (Vatican City State)';
Italian
...
SELECT name, percentage FROM country JOIN countrylanguage ON country.code = countrylanguage.countrycode WHERE language = 'Italian' ORDER BY percentage
San Marino
